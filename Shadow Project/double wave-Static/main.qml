...
Window {
    ...
    function do_it(referenceToMyGraph,number)
    {
        ...
        if(graphSettings.items[graphSettings.currentSelection] > 10)
             referenceToMyGraph.referencetoXAxis.max=mywaveform.xmin() + graphSettings.items[graphSettings.currentSelection];
        else
